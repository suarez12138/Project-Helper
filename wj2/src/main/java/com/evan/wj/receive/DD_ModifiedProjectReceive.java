...
public class DD_ModifiedProjectReceive {
    String token;
    int course_id;
    String project_name;
    ...
    public DD_ModifiedProjectReceive(String token, int course_id, String project_name, List<Integer> project_member_limit, List<String> project_pre_week, String pro_grouping_endDay, String pro_grouping_endHms, String across_lab, List<String> all_tags, String choosable_proj) {
        this.token = token;
